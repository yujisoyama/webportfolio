...
export function Projects() {
  return (
    <div id="projects">
      ...
      <div className="flex flex-wrap justify-center items-start gap-10 p-8 mt-4">
        {PROJECTS.map((project) => (
          <div
            key={project.title}
            className="flex flex-col h-120 items-center justify-center gap-8 p-8 border-2 border-border shadow-2xl transition hover:-translate-y-1 sm:max-w-80"
          >
