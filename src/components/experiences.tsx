...
export function Experiences() {
  return (
    <div id='experiences' className="flex flex-col items-center justify-center gap-14 p-8 mt-8">
      ...
      {EXPERIENCES.map((exp) => (
        <div
          key={exp.title}
          className="flex flex-col items-center justify-center gap-4 p-8 border-2 border-border shadow-2xl transition hover:-translate-y-1 sm:max-w-150"
        >
